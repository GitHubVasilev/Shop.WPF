...
{
    /// <summary>
    /// Интрефейс классов взаимодействия с источником данных MS Access
    /// </summary>
        ...
        where T: BaseEntity
    {
        ...
        /// </summary>
        /// <param name="initalCatalog">Строка подключения к источнику данных</param>
        /// <returns></returns>
        Task ConnectAsync(string initalCatalog, string login, string password);
        /// <summary>
